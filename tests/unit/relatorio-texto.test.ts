...
import { semAbreviacaoColab, textosDoRelatorio } from '@/lib/season-engine/relatorio-texto';
  ...
  it('corrige todo texto de IA que vira leitura para a pessoa, e só ele', () => {
    const dados = textosDoRelatorio({
      ...
      evolutionReport: {
        ...
        descritores: [{ descritor: 'D1', antes: 'A colab resolvia.', depois: 'A colab registra.', nota_pre: 1, nota_pos: 2 }],
        resumo: { parciais: 1 },
      },
      momentos: [{ semana: 1, insight: 'A colab percebeu.' }],
