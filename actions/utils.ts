 ...
 */
export async function extractJSON(text: string | null | undefined): Promise<any> {
 ...
 */
export async function extractBlock(text: string | null | undefined, tag: string): Promise<any> {
 ...
 */
export async function stripBlocks(text: string | null | undefined): Promise<string> {
  if (!text) return '';
  return text
