...
async function main() {
  ...
  for (const envio of alvos) {
    ...
    // Cadência pela política única, ANTES do envio (ela desconta o tempo já
    // gasto pela chamada anterior). O literal que estava aqui era `2000` — o
    // ritmo exato do incidente de 11/08, em que 155 mensagens a 2s derrubaram o
    // número em 1min47 —, sob um comentário dizendo "mesmo ritmo do QStash";
    // o QStash é justamente quem foi corrigido naquele dia.
