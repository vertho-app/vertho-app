...
export const CALLS = [
  ...
  // ── PERFIL DISC (uma vez por colab, cacheado 30 dias) ──
  {
    ...
    fase: 'Mapeamento Comportamental',
    scaleType: 'colab',
    nome: 'Relatório Comportamental — textos LLM',
    descricao: 'Gera os textos interpretativos do relatório de Mapeamento Comportamental (5 páginas) a partir do perfil CIS. Cache 30 dias em colaboradores.report_texts.',
    inTokens: 3000,
    outTokens: 2500,
    exec: 1,
  ...
  },
  {
    ...
    descricao: '3-4 insights curtos a partir do Mapeamento Comportamental + competências. Cache 30 dias em colaboradores.insights_executivos.',
    inTokens: 2000,
    outTokens: 600,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
  ...
  },
  {
    ...
    descricao: 'Áudio de Mapeamento Comportamental (~3-4 min), voz Algieba no 2.5 Flash desde 07/09. Retakes em série; calibração do uso longo projeta 2,4 tentativas médias (máx. 5), ~US$ 0,08 por devolutiva.',
    inTokens: 500,
    outTokens: 3300,
    exec: 2.4,
    defaultModel: 'gemini-2.5-flash-tts',
  ...
  //  Módulo-Base" abaixo, com avatar HeyGen + Remotion.)
  {
    ...
    fase: 'Geração de Conteúdo',
    scaleType: 'conteudo',
    nome: 'Personalização comportamental + PPP (PDF)',
    descricao: 'Camada extra por conteúdo × arquétipo comportamental. Média real de 90 dias no Sonnet 4.6 (10/09/2026); exec=4 arquétipos.',
    inTokens: 3830,
    outTokens: 610,
    exec: 4,
    defaultModel: 'claude-sonnet-4-6',
