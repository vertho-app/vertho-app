...
| **Engajamento da trilha (telemetria)** *(jul-set/2026)* | Visão atual em `/admin/engajamento` + página longitudinal em `/admin/engajamento/evolucao`: ativação, consumo e evidência por semana, etapa individual separada do calendário da turma, trajetórias, recuperados, heatmap por área e fila operacional de risco | Distingue “recebeu” de “engajou” e “a turma chegou à semana N” de “esta pessoa concluiu até N−1” — RH identifica pendências reais, recuperação e áreas que precisam de apoio. |
