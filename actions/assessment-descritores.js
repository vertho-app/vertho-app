 ...
 */
export async function loadAssessmentGrid(empresaId, competenciaFiltro = null) {
  try {
 ...
 */
export async function salvarNotaAssessment({ empresaId, colaboradorId, competencia, descritor, nota, cargo }) {
  try {
    const sb = createSupabaseAdmin();
 ...
 */
export async function deletarNotaAssessment({ colaboradorId, competencia, descritor }) {
  try {
    const sb = createSupabaseAdmin();
