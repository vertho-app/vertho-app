...
export function promptEvolutionScenarioScore({ competencia, descritores, cenario, resposta, nomeColab, perfilDominante, evidenciasAcumuladas }) {
...
- Compare a resposta ao cenário com os comportamentos da régua E com as evidências das 13 semanas anteriores.
- Se a resposta ao cenário diverge muito da evidência acumulada (ex: cenário mostra N3 mas os relatos das semanas sugerem N1-2), pondere pra baixo — a resposta pode ser atípica/ensaiada. Anote isso na justificativa.
- Se a resposta reforça o padrão acumulado, a nota reflete o padrão.
...
- 4.0 só se demonstrou CONSISTENTEMENTE (resposta + acumulado) o comportamento de referência.
...
EVIDÊNCIAS ACUMULADAS NAS 13 SEMANAS (TRIANGULE COM A RESPOSTA ACIMA):
${evidenciasAcumuladas || '(sem evidências acumuladas disponíveis — confie só na resposta ao cenário e na régua)'}
