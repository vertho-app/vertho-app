...
const TABELAS_TENANT = ['trilhas', 'colaboradores', 'temporada_semana_progresso', 'banco_cenarios', 'competencias', 'cargos_empresa', 'micro_conteudos', 'sim_vendas_config', 'sim_vendas_sessoes', 'sim_vendas_tentativas', 'sim_lideranca_jornadas', 'sim_lideranca_episodios', 'sim_lideranca_chamadas'];
