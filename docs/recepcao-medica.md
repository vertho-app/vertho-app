...
- **Cenários:** catálogo comum e versões da clínica. Crie uma cópia, adapte a ficha, os pacientes e as competências avaliadas (checkbox, peso e critério do caso); salve o rascunho e publique. Publicação exige `content.manage`. Uma versão publicada não pode ter seu conteúdo alterado. Arquivar impede novos treinos dessa versão, preservando as sessões existentes.
