...
export function BettLeadModal({
  ...
  function handleSchedule() {
    ...
    // Por enquanto: abre WhatsApp como fallback. Calendly entra quando configurado.
    handleWhatsApp();
  }
            ...
            <div className="text-center py-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-4">
                <button onClick={handleSchedule}
                  className="inline-flex items-center justify-center gap-1.5 py-2.5 rounded-full text-[12px] font-bold border border-cyan-400/30 text-cyan-300 hover:bg-cyan-400/10 transition-colors">
                  <Calendar size={12} /> Agendar conversa
                </button>
                <button onClick={handleWhatsApp}
                  className="inline-flex items-center justify-center gap-1.5 py-2.5 rounded-full text-[12px] font-bold border border-green-400/30 text-green-300 hover:bg-green-400/10 transition-colors">
                  <MessageCircle size={12} /> Conversar pelo WhatsApp
                </button>
              </div>
