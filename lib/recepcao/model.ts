...
export type Gerar = (args:{etapa:string;perfilPaciente?:'negociavel'|'resistencia_persistente';escala?:'n4'|'legado';system:string;messages:Array<{role:'user'|'assistant';content:string}>})=>Promise<string>;
