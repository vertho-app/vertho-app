...
Não gere P, A, C, E, Media nem Violacoes: o servidor calcula notas e penalidades. Os textos Preparacao, Analise, Cocriacao, Engajamento e Resumo devem explicar os comportamentos, sem inventar números. Recomendações apontam descritores prioritários e uma ação prática para avançar.
