...
export const ACME_DEMO_REPORT_DIRECTORY: AcmeDemoDirectoryPerson[] = [
  ...
  { key: 'marcelo', nome_completo: MARCELO.nome, email: MARCELO.email, cargo: 'Gerente Comercial', role: 'gestor', area_depto: 'Comercial', gestor_nome: null, gestor_email: null, d_natural: 52, i_natural: 74, s_natural: 46, c_natural: 28 },
