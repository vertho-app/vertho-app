...
// Tab "Sem 13" do workspace de auditorias — conteúdo extraído da antiga
// /admin/vertho/avaliacao-acumulada (Reorganização do admin, Fase 3).
...
import { listarAvaliacoesAcumuladas, loadAvaliacaoAcumuladaDetalhe, regerarAvaliacaoAcumulada } from '@/app/admin/vertho/avaliacao-acumulada/actions';
...
export default function Sem13Tab({ empresaId }: { empresaId: string | null }) {
  ...
  if (error && !rows.length) {
    return <div className="min-h-full flex items-center justify-center py-12"><p className="text-red-400">{error}</p></div>;
  }
