...
export const CALLS = [
  ...
  // ── AVALIAÇÃO ACUMULADA (fim sem 13) ──
  {
    id: 'acumulada-primaria',
    fase: 'Acumulada',
    nome: 'IA Acumuladora (nota por descritor)',
    descricao: 'Lê 13 semanas e pontua 1-4 por descritor, cega pra nota inicial.',
    inTokens: 4500,
    outTokens: 900,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
  ...
  },
  {
    ...
    descricao: '2ª IA audita a acumulada.',
    inTokens: 5500,
    outTokens: 600,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
  ...
  // ── SEM 14 ──
  {
    ...
    descricao: 'Pontua resposta ao cenário B triangulando com acumulada.',
    inTokens: 5500,
    outTokens: 1000,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
  ...
  },
  {
    ...
    descricao: '2ª IA audita a avaliação final.',
    inTokens: 6500,
    outTokens: 600,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
  ...
  // ── RELATÓRIOS ──
  {
    id: 'evolution-report',
    fase: 'Relatórios',
    nome: 'Evolution Report',
    descricao: 'Consolida sems 13+14 em relatório final.',
    inTokens: 4000,
    outTokens: 1500,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
  ...
  },
  {
    ...
    fase: 'Relatórios',
    nome: 'PDI Individual',
    descricao: 'Plano de desenvolvimento individual gerado por IA.',
    inTokens: 3000,
    outTokens: 1500,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
  ...
  },
  {
    ...
    descricao: 'Síntese do ciclo pra RH/gestor.',
    inTokens: 3500,
    outTokens: 2000,
    exec: 1,
    defaultModel: 'claude-sonnet-4-6',
