  ...
  return (
    ...
    >
      ...
      <article className="max-w-[760px] mx-auto px-6 pb-16">
        <Link href="/" className="inline-flex items-center gap-1.5 text-xs text-white/45 hover:text-white mb-6 mt-6">
        ...
        <h1
          className="text-white mb-6 serif"
          style={{
        ...
        <div className="text-white/75 leading-relaxed space-y-6 text-[15px]">
          <p>
          ...
          <Section titulo="Comparações">
            <p>Os percentuais por nível são apresentados ao lado de quatro benchmarks oficiais:</p>
          ...
          <Section titulo="Escala de níveis (cumulativa)">
            <p>
              Cada disciplina e etapa tem uma escala numérica dividida em níveis.{' '}
              <strong>A escala é cumulativa:</strong> um estudante classificado no nível N domina
              também as habilidades dos níveis 0 a N−1. Os níveis variam:
            </p>
          ...
          <Section titulo="Como citar o Radar">
            <p>Para uso em pesquisas, reportagens e relatórios institucionais, citar como:</p>
            <p
              className="mt-3 px-4 py-3 rounded-lg border border-white/[0.08] text-sm font-mono text-white/80"
          ...
          <Section titulo="Privacidade e LGPD">
            ...
            <p className="mt-3">
              ...
              qualquer momento via{' '}
              <a href="mailto:dpo@vertho.ai" className="text-cyan-400 hover:underline">
                dpo@vertho.ai
              </a>.
            </p>
          </Section>
          ...
          <Section titulo="Equipe e contato">
            <p>
              O Radar é desenvolvido pela{' '}
              <a href="https://vertho.ai" className="text-cyan-400 hover:underline">
                Vertho Mentor IA
              </a>{' '}
              como funil autoral de diagnóstico público. Sugestões, correções e parcerias são
              bem-vindas:{' '}
              <a href="mailto:radar@vertho.ai" className="text-cyan-400 hover:underline">
                radar@vertho.ai
              </a>.
            </p>
          </Section>
...
function Section({ titulo, children }: { titulo: string; children: React.ReactNode }) {
  return (
    <section className="pt-2">
      <h2 className="text-white text-xl font-bold mb-3 mt-8 serif">{titulo}</h2>
      {children}
    </section>
  );
}
