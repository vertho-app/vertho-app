...
beforeEach(()=>{
 ...
 c={empresaId:'empresa',dominio:'recepcao_medica',ownerKey:'colab:gestora',owner:'gestora@example.test',sb:banco(),auth:{role:'gestor',empresaId:'empresa',isPlatformAdmin:false,colaborador:{id:'gestora',empresa_id:'empresa',email:'gestora@example.test',nome_completo:'Gestora'}}};
});
