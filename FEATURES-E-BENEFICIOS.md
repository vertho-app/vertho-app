...
| **Mapeamento Comportamental (DISC)** | Instrumento DISC completo em 29 passos, com **vídeo de instruções** na abertura e relatório detalhado (16 competências + insights executivos por IA) | Autoconhecimento profundo do estilo comportamental, gratuito como entrada no programa — guiado por vídeo pra reduzir dúvidas. |
