...
| **PDI Personalizado** | Plano de Desenvolvimento Individual gerado por IA a partir do que a pessoa escreveu no cenário: resumo, plano de 30 dias (foco e ações, copiadas do plano da jornada), estudo recomendado. Todo PDI é conferido por uma 2ª IA de outra família, que aponta afirmação sem base nas respostas; o veredito (aprovado, alerta, reprovado) aparece no painel da equipe, com o trecho e o motivo, e o PDI pode ser regerado por pessoa | Plano concreto e curto, focado em 30 dias, não "encheção de relatório", e que só diz sobre a pessoa o que as respostas dela mostram. |
