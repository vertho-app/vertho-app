 ...
 */
export function promptPodcastScript({ competencia, descritor, nivelMin = 1.0, nivelMax = 2.0, cargo = 'todos', contexto = 'generico' }) {
  ...
  const user = `Crie 1 roteiro de áudio/podcast de 3-5 min.
