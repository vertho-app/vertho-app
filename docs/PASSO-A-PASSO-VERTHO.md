...
- **26-27/07 — uma fonte de contexto institucional por empresa** (`062dca13` + 27/07): empresa-rede tem 1 PPP por escola (Ibipeba: 11), e o `.limit(1)` autorava a régua do município inteiro com uma escola sorteada. Classe **F-I10** no `docs/FMEA-PIPELINE.md`, agora fechada nos 4 consumidores (valores do IA2, `buscarContextoPPP` de IA1/IA2/IA3, check dual do IA3, PDF personalizado) — régua, kit e PDF na mesma lente. No 26/07, os 2 guards de tenant voltaram ao verde (`3367efb7`).
