...
const ICONS: Record<string, any> = { Video, Film, FileText, Headphones, BarChart3, Dumbbell, Users, BookOpen };

interface PreferenciasRankingProps {
  data?: any;
...
export default function PreferenciasRanking({ data, title, subtitle, compact = false }: PreferenciasRankingProps) {
  ...
  const valores = ranking.map((r: any) => Number(r?.media) || 0);
