...
## Pegadinhas
- **22/09/2026 — engajamento mede a etapa atual.** A visão sem filtro deixou de somar sinais de temporadas anteriores: cada pessoa é lida na semana que consegue abrir na jornada mais recente. A ACME posiciona Bruna na semana 2, com a semana 1 concluída e uma conversa de evidência coerente. Os sinais fictícios atuais formam uma progressão de acesso → consumo → entrega, em vez de quatro cartões em 100% e todas as pendências em zero. RH e liderança veem o status da entrega e o nível da reflexão (alta, média ou baixa); o relato continua privado.
