...
export const ACME_DEMO_REPORT_DIRECTORY: AcmeDemoDirectoryPerson[] = [
  ...
  { key: 'marcelo', nome_completo: MARCELO.nome, email: MARCELO.email, cargo: 'Gerente Comercial', role: 'gestor', area_depto: 'Comercial', gestor_nome: null, gestor_email: null, d_natural: 76, i_natural: 56, s_natural: 28, c_natural: 40 },
  ...
  { key: 'leandro', nome_completo: 'Leandro Castro', email: 'leandro.demo@vertho.ai', cargo: 'Analista Financeiro', role: 'colaborador', area_depto: 'Financeiro', gestor_nome: JULIANA.nome, gestor_email: JULIANA.email, d_natural: 36, i_natural: 29, s_natural: 58, c_natural: 77 },
  { key: 'natalia', nome_completo: 'Natália Braga', email: 'natalia.demo@vertho.ai', cargo: 'Analista Financeiro', role: 'colaborador', area_depto: 'Financeiro', gestor_nome: JULIANA.nome, gestor_email: JULIANA.email, d_natural: 24, i_natural: 35, s_natural: 66, c_natural: 75 },
  ...
  { key: 'henrique', nome_completo: 'Henrique Moraes', email: 'henrique.demo@vertho.ai', cargo: 'Coordenador de Operações', role: 'colaborador', area_depto: 'Operações', gestor_nome: EDUARDO.nome, gestor_email: EDUARDO.email, d_natural: 69, i_natural: 31, s_natural: 52, c_natural: 48 },
  { key: 'larissa', nome_completo: 'Larissa Teixeira', email: 'larissa.demo@vertho.ai', cargo: 'Coordenador de Operações', role: 'colaborador', area_depto: 'Operações', gestor_nome: EDUARDO.nome, gestor_email: EDUARDO.email, d_natural: 46, i_natural: 42, s_natural: 65, c_natural: 47 },
  { key: 'rodrigo', nome_completo: 'Rodrigo Farias', email: 'rodrigo.demo@vertho.ai', cargo: 'Coordenador de Operações', role: 'colaborador', area_depto: 'Operações', gestor_nome: EDUARDO.nome, gestor_email: EDUARDO.email, d_natural: 63, i_natural: 35, s_natural: 57, c_natural: 45 },
